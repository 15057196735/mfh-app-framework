...
/**
 * <p>
 * A specialized Drawable dedicated to {@link com.mfh.comna.actionbar.ActionBarItem}s. It automatically
 ...
 * should be used in {@link com.mfh.comna.actionbar.ActionBar}s.
 * </p>
 * <p>
...
public class ActionBarDrawable extends BitmapDrawable {
     ...
     * @deprecated Use {@link com.mfh.comna.actionbar.ActionBarDrawable#ActionBarDrawable(android.content.Context, int)}
     ...
     * @deprecated Use
     *             {@link com.mfh.comna.actionbar.ActionBarDrawable#ActionBarDrawable(android.content.Context, android.graphics.drawable.Drawable)}
     *             as it looks for the default alternative/normal colors in the
     *             theme.
     */
    @Deprecated
     ...
     * @deprecated Use
     *             {@link com.mfh.comna.actionbar.ActionBarDrawable#ActionBarDrawable(android.content.Context, int, int, int)}
     *             as it looks for the default alternative/normal colors in the
     *             theme.
     */
    @Deprecated
     ...
     * @param altColor The color used to color the icon in alternative mode
     * @deprecated Use
     *             {@link com.mfh.comna.actionbar.ActionBarDrawable#ActionBarDrawable(android.content.Context, android.graphics.drawable.Drawable, int, int)}
     *             as it looks for the default alternative/normal colors in the
     *             theme.
     */
    @Deprecated
