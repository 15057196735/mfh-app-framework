...
/**
 * Base class representing an {@link com.mfh.comna.actionbar.ActionBarItem} used in {@link com.mfh.comna.actionbar.ActionBar}s.
...
public abstract class ActionBarItem {
    ...
    /**
     * The Type specifies a large set of pre-defined {@link com.mfh.comna.actionbar.ActionBarItem}s that
     * may be added to an {@link com.mfh.comna.actionbar.ActionBar}.
     * 
     * @author Cyril Mottier
     */
    public enum Type {
    ...
    void setActionBar(BaseActionBar actionBar) {
    ...
    static ActionBarItem createWithType(BaseActionBar actionBar, Type type) {
        ...
        return actionBar.newActionBarItem(NormalImgActionBarItem.class).setDrawable(d).setContentDescription(descriptionId);
    }
