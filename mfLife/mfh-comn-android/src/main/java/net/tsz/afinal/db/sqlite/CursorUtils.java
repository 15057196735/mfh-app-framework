...
public class CursorUtils {
     ...
     */
    public static boolean isSimpleValue(Class<?> beanClass) {
     ...
     * @return
     */
    public static <T> T getSimpleObject(Cursor cursor, Class<T> clazz){
        try {
            if(cursor != null ){
                T value = TypeUtils.castToJavaBean(cursor.getString(0), clazz);
                return value;
            }
        } catch (Exception e) {
